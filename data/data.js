const data = [
    {
        ...
        userPersona : {
            ...
            what our personas could be like. Here’s an example:
            </div>`,
        ...
        userJourney: {
            header: 'USER JOURNEY AND INFORMATION ARCHITECTURE 📝',
    ...
    },
    {
        ...
        challenge : {
            ...
            one of India’s largest co-working space providers. Their team wanted to build an app and
            a desktop site that could help their users <b>book rooms</b> & a way for each startup to create
            their <b>own team</b>. To put it in their words “a combination of seat booking like MakeMyTrip
            and social networking like LinkedIn”. I worked on the desktop UX design which also had
        ...
        knowUser: {
            header: 'KNOWING OUR USERS 👨‍👨‍👧‍👦',
            html: `<div>After talking to a few founders and from our understanding of working in a space 
            that wasn’t a share office, we gathered the following information:</div>`,
        ...
        wireframe: {
            ...
            innerSection: [{
                ...
                html: `<div>Although these ideas were dropped once the beta version was launched and didn’t
    ...
    },
    {
        ...
        challenge : {
            ...
            <div>
                ...
                conscious decision, at the same time keeping in mind that this shouldn’t be long, tedious
                process.
            </div><br />
        ...
        solution: {
            ...
            innerParagraph: [{
                ...
                it’s USP. These red:deal offer cards were also a selling point for bus operators, this 
            ...
            },
            {
                ...
                could accomodate only some of this information and wasn’t very intuitive; the google
        ...
        userPersonaIdeation: {
            header: 'USER PERSONA 👨🏻 and IDEATION 💡 ',
    ...
    },
    {
        ...
        shortImg:null,
        title:"Designing a 1st of it’s kind whatsapp bus ticket",
